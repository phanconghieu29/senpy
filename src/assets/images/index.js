const images = {
    ...
    roadmap: require("../images/roadmap1.jpg"),
    homeBanner: require("../images/home_banner_1.jpg"),
    aboutBanner: require("../images/about_banner_1.jpg"),
    post1: require("../images/post1.jpg"),
    post2: require("../images/post2.jpg"),
    post3: require("../images/post3.jpg"),
    event1: require("../images/HUITCO-1244.jpg"),
